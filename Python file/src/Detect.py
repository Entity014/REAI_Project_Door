...
def detectH():
    ...
    while cap.isOpened():
        ...
        if (data2JSON == [{"Qr": "Master", "Hands": "pass0"}] or data2JSON == [{"Qr": "Slave", "Hands": "pass1"}]):
...
# def detectF():
#     cap = cv2.VideoCapture(0)
#     phytes_image = face_recognition.load_image_file("D:\Programming\Python\AI\REAI-Pro\image\Phytes.jpg")
#     phytes_encoding = face_recognition.face_encodings(phytes_image)[0]
    
#     pong_image = face_recognition.load_image_file("D:\Programming\Python\AI\REAI-Pro\image\Pong.jpg")
#     pong_encoding = face_recognition.face_encodings(pong_image)[0]
    
#     pmos_image = face_recognition.load_image_file("D:\Programming\Python\AI\REAI-Pro\image\Pmos.jpg")
#     pmos_encoding = face_recognition.face_encodings(pmos_image)[0]

#     person_face_encodings = [pong_encoding, pmos_encoding]
#     person_face_names = ["Pong", "Pmos"]
